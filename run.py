...
def getGenders(names):
	...
	retrn = []
	#reached_limit = isinstance(results, list) and results.get("error", None) is not None
	reached_limit = not isinstance(results, list)
...
if __name__ == "__main__":
	...
	parser.add_argument('--academic-year', required=True, 
						help='Get the ID of academic year (e.g. for 2018-2019 it was 1866893861). Go to the: http://isa.epfl.ch/imoniteur_ISAP/%21gedpublicreports.htm?ww_i_reportmodel=133685247 and select a year. Observe in the Web console, Network tab, what is the ID of the academic year.')

	args = parser.parse_args()

	# academic_period = {"2018-2019": "1866893861", "2019-2020": "1866894985"}
	...
	extract_msc_bsc_emails(args.username, args.password, MSC_BSC_public=False, MSC_BSC_report_type="HTML", MSC_BSC_ww_x_PERIODE_PEDAGO="null", 
	                        ...
	                        MSC_BSC_ww_x_GPS="-1", MSC_BSC_ww_x_PERIODE_ACAD=str(args.academic_year), 
